...
type AuthUserRoleModel struct {
	...
	ExpiredDate commtypes.JSONDatetime `gorm:"type:timestamp;default:normal;column:expired_date" json:"expiredDate"`
	CreatedBy   string                 `gorm:"size:64;not null;column:created_by" json:"createdBy"`
	CreatedAt   commtypes.JSONDatetime `gorm:"timestamp;not null;default:CURRENT_TIMESTAMP;column:created_at" json:"createdAt"` //nolint:lll
