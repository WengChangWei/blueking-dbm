...
// IAM action_id 模板中重复使用的字符串常量
const (
	iamActionModify         = "{type}_modify"
	iamActionScale          = "{type}_scale"
	iamActionK8sAddonManage = "k8s_addon_manage"
)
...
var APIToIAMAction = map[string]string{
	...
	APIAddonInstall:         iamActionK8sAddonManage,
	APIAddonUninstall:       iamActionK8sAddonManage,
	APIAddonUpgrade:         iamActionK8sAddonManage,
}
